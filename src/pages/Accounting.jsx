  ...
  const services2 = [
    {
      ...
      description: "Ensure all documents meet quality and regulatory standards before submission.",
    },
    {
      title: "Financial & Risk Analysis",
      description: "Assess applicant profiles, income, debt ratios, and credit to mitigate lending risks.",
    },
    {
      title: "Loan File Processing",
      description: "Handle mortgage and insurance loan file submissions from start to finish.",
    },
    {
      title: "Compliance Checks",
      description: "Validate documentation for FHA, VA, Fannie Mae, Freddie Mac, and more.",
    },
    {
      title: "Client & Broker Communication",
      description: "Maintain seamless coordination with clients, brokers, and third-party agencies.",
    },
  ];
  ...
  const seoServices =[
    {
      ...
      description: "Automate workflows using macros, pivot tables, VLOOKUP, and advanced formulas.",
    },
    {
      title: "Custom Financial Models",
      description: "Build tailored financial forecasting and modeling tools for decision-making.",
    },
    {
      title: "Business Dashboards",
      description: "Create interactive dashboards for real-time reporting and performance tracking.",
    },
    {
      title: "Spreadsheet Optimization",
      description: "Fix errors, reduce file sizes, and enhance speed and accuracy of sheets.",
    },
    {
      title: "System Integration",
      description: "Connect Excel with accounting software and databases for seamless data flow.",
    },
  ];
...
<div className="bg-gray-900 w-full min-h-screen flex flex-col items-center justify-center text-center px-4 py-16 md:py-24 lg:py-28">
  ...
  />
      ...
      <div className="mt-30 text-center flex flex-col items-center gap-4">
        <h1 className="text-5xl font-bold text-gray-900">
          Excel Expertise <br /> Financial
Modeling
        </h1>
        <p className="text-lg text-600 w-[50%]">
        Our Excel specialists deliver automation, dashboards, and
financial models that save time and boost decisionmaking. From complex formulas to custom templates, we
